...
@theme {
  ...
  /* Google brand mark — fixed four-color logo, never substitute the accent palette */
...
- Google's logo always uses `--google-blue`/`--google-green`/`--google-yellow`/`--google-red` — never the accent palette or inline hex
